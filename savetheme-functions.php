...
function themify_viewport_tag(){
	echo '<meta name="viewport" content="width=100%, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=yes">';
}
...
/***************************************************************************/
	...
	{   global $post;
        ...
        /*START ORIG function register_custom_nav() {
        ...
        function register_custom_nav() {
                if (function_exists('register_nav_menus')) {
                        register_nav_menus( array(
                                'main-nav' => __( 'Header Navigation', 'themify' ),
                                'footer-nav' => __( 'Footer Navigation', 'themify' ),
                        ) );
                }
        }
