...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-31185876-1']);
        ...
        <div id="toplogo-bar">
			<div class="pagewidth clearfix">
 				<div class="logo"><a class="urilogo" href="http://www.uri.edu" title="URI Home Page">The University of Rhode Island</a>
                        ...
                        <div class="logoprint"><img src="<?php bloginfo('template_directory'); ?>/images/logo-print.png" alt="URI" /></div>
                 
 				<!-- Search Form -->
				 <?php if(!themify_check('setting-exclude_search_form')): ?>
	
     			 <div class="sf">
				<form method="get" action="http://blogs.web.uri.edu/search/" name="global_general_search_form">
                ...
                <!-- Quick Links -->
                <div class="quick"><a href="http://www.uri.edu/news/myuri/"><img src="<?php bloginfo('template_directory'); ?>/images/icon_mail.png" alt="my.uri.edu" />Webmail</a><a href="http://web.uri.edu/ecampus/"><img src="<?php bloginfo('template_directory'); ?>/images/icon_ecampus.png" alt="eCampus" />eCampus</a><a href="https://sakai.uri.edu"><img src="<?php bloginfo('template_directory'); ?>/images/icon_sakai.png" alt="Sakai at URI" />Sakai</a>
                </div>
                <div class="lhwm"><img src="<?php bloginfo('template_directory'); ?>/images/wmprint.png" alt="Think Big, We Do." /></div>
                                <div style="clear:both;"></div>
                <div id="riseal"><img src="<?php bloginfo('template_directory'); ?>/images/wmbprint.png" alt="Rhode Island Seal" /></div>
             </div>
    ...
    <div id="topdept-bar">
        ...
        <?php if(themify_get('setting-site_logo') == 'image' && themify_check('setting-site_logo_image_value')){ ?>
            ...
            <div id="urihomebutton">
        		<a href="http://www.uri.edu/"><img src="<?php bloginfo('template_directory'); ?>/images/icon_urihomepage.png" alt="URI Homepage" />URI Homepage</a>
			</div>
            <?php } ?>
    ...
    <header id="header" class="pagewidth">
		...
		<!--/header widget --> 
			...
			<?php if(!themify_check('setting-exclude_rss')): ?>
				...
				<img src="<?php bloginfo('template_directory'); ?>/images/icon_facebook.png" alt="Facebook" /></a>
                <?php } ?>
				...
				<img src="<?php bloginfo('template_directory'); ?>/images/icon_twitter.png" alt="Twitter" /></a>
                <?php } ?>
				...
				<img src="<?php bloginfo('template_directory'); ?>/images/icon_google_plus.png" alt="Google Plus" /></a>
                <?php } ?>
				...
				<img src="<?php bloginfo('template_directory'); ?>/images/icon_youtube.png" alt="Youtube" /></a>
                <?php } ?>
                ...
                <img src="<?php bloginfo('template_directory'); ?>/images/icon_rss.png" alt="RSS" width="16" height="16" /></a>
                <?php } ?>
