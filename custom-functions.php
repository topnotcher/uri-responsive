...
//add_action('admin_menu','add_uri_options_admin_menus');
	...
	function add_uri_options_admin_menus() {
     ...
     //add_menu_page('URI Options', 'URI Options', 'manage_options', 'uri_options', 'theme_uri_options', null, 59);
	...
	} //end function theme_uri_network_options()
...
/********************************************************/
	...
	}//end function uri_responsive_enqueue_scripts()
