...
/***************************************************************************/
	...
	function themify_admin_nav() {
		...
		add_menu_page('URI Responsive', $theme['Name'], 'manage_options', 'themify', 'themify_page', get_template_directory_uri().'/themify/img/favicon.png', 50);
		//add_submenu_page('themify', $theme['Name'], __('Settings', 'themify'), 'manage_options', 'themify', 'themify_page');
		add_submenu_page('URI Responsive', $theme['Name'], __('Settings', 'themify'), 'manage_options', 'themify', 'themify_page');
...
/***************************************************************************/	
	...
	function themify_page() {
        ...
        <!-- js -->
                ...
                //added new upload image path
                var upload_url = "<?php echo BLOGUPLOADURL; ?>/";
        ...
        <!-- ORIG CODE TO LINK TO CHANGELOG
        ...
        <!-- REVISDED CODE TO REMOVE CHANGELOG -->
          <p id="theme-title"><?php echo $theme['Name']; ?> <em><?php echo $theme['Version']; ?></em></p>
		...
		if(is_array($data)){
			foreach($data as $name => $value){	
				...
				foreach($array as $part){
					if (!is_array($path[$part])) $path[$part] = array();
		...
		if(function_exists('add_meta_box') && is_array($themify_write_panels)){
			foreach($themify_write_panels as $args){
				...
				foreach($pages as $page){
					add_meta_box( 'themify-meta-boxes', __('URI Custom Panel', 'themify'), 'themify_meta_boxes', trim($page), 'normal', 'high' ); 
				}
			}
		}
	}  
