...
*/
	...
	class Themify_Feature_Posts extends WP_Widget {
		...
		function Themify_Feature_Posts() {
			...
			/* Create the widget. */
			$this->WP_Widget( 'themify-feature-posts', __('URI - Feature Posts', 'themify'), $widget_ops, $control_ops );
		}
	...
	class Themify_List_Pages extends WP_Widget {
		...
		function Themify_List_Pages() {
			...
			/* Create the widget. */
			$this->WP_Widget( 'themify-list-pages', __('URI - List Pages', 'themify'), $widget_ops, $control_ops );
		}
	...
	class Themify_List_Categories extends WP_Widget {
		...
		function Themify_List_Categories() {
			...
			/* Create the widget. */
			$this->WP_Widget( 'themify-list-categories', __('URI - List Categories', 'themify'), $widget_ops, $control_ops );
		}
	...
	class Themify_Recent_Comments extends WP_Widget {
		...
		function Themify_Recent_Comments() {
			...
			/* Create the widget. */
			$this->WP_Widget( 'themify-recent-comments', __('URI - Recent Comments', 'themify'), $widget_ops, $control_ops );
		}
	...
	class Themify_Links extends WP_Widget {
		...
		function Themify_Links() {
			...
			/* Create the widget. */
			$this->WP_Widget( 'themify-links', __('URI - Banners &amp; Links', 'themify'), $widget_ops, $control_ops );
		}
	...
	class Themify_Twitter extends WP_Widget {
		...
		function Themify_Twitter() {
			...
			/* Create the widget. */
			$this->WP_Widget( 'themify-twitter', __('URI - Twitter', 'themify'), $widget_ops, $control_ops );
	...
	class Themify_Flickr extends WP_Widget {
		...
		function Themify_Flickr() {
			...
			/* Create the widget. */
			$this->WP_Widget( 'themify-flickr', __('URI - Flickr', 'themify'), $widget_ops, $control_ops );
		}
	...
	class Themify_Most_Commented extends WP_Widget{
		...
		function __construct(){
			...
			parent::__construct( 'themify-most-commented', __('URI - Most Commented', 'themify'), $widget_ops, $control_ops );
		}
