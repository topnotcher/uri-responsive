 ...
 ***************************************************************************/
	...
	define( 'THEMIFYMIN', defined('SCRIPT_DEBUG') && SCRIPT_DEBUG ? '' : '.min' );
         /*define two new image upload path to go to wp-content/blogs.dir/blogid/files fol    der */
        define( 'BLOGUPLOADDIR', WP_CONTENT_DIR . '/blogs.dir/{$wpdb->blogid}/files' );
        define( 'BLOGUPLOADURL', WP_CONTENT_URL . "/blogs.dir/".$blog_id."/files" );
...
function themify_admin_bar() {
	...
	$wp_admin_bar->add_menu( array(
		'id' => 'themify-settings',
		'parent' => 'appearance',
		'title' => __( 'URI Responsive Theme Settings', 'themify' ),
