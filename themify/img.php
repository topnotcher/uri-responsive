...
define ('FILE_CACHE_TIME_BETWEEN_CLEANS', 3600);	// Minimum time between checking if the cache needs cleaning
define ('FILE_CACHE_SIZE', 1000);			// Number of files to store before clearing cache (once time betweeen cleans has elapsed)
define ('FILE_CACHE_MAX_FILE_AGE', 3600);		// How old does a file have to be to be deleted from the cache
...
//Browser caching
define ('BROWSER_CACHE_MAX_AGE', 259200);		// Time to cache in the browser
