...
/***************************************************************************/
	...
	function themify_site_logo($data=array()){
		...
		return '<p>
					<span class="label">'. __('Display', 'themify') .'</span> 
						<input name="setting-site_logo" type="radio" value="text" '.$text.' /> ' . __('Default Image', 'themify') . ' 
						<input name="setting-site_logo" type="radio" value="image" '.$image.' /> ' . __('Custom Image', 'themify') . '
					</span>
					'.$target.'
					...
					<span class="pushlabel image" '.$image_display.'>
						' . themify_has_quota('<a href="#" id="setting-'.$data['category'].'-'.$data['title'].'-site_logo" class="upload-btn upload-image logo">' . __('<b>+ Click Here to Upload!</b>', 'themify') . '</a>') . '
					</span>
					<span class="pushlabel clear image" '.$image_display.'>
					Width:	<input type="text" name="setting-site_logo_width" class="width2" value="'.$data['setting-site_logo_width'].'" /> ' . __(' px.  <i>Image width must be set as 190px.</i><br />', 'themify') . ' 
					Height:	<input type="text" name="setting-site_logo_height" class="width2" value="'.$data['setting-site_logo_height'].'" /> ' . __('px. <i>Image height must be set as 90px.</i>', 'themify') . '
					</span>
				</p>';
	}
	...
	add_action('admin_head', 'themify_favicon_action');
        ...
        ///////////////////////////////////////////
        // Custom Facebook URL Module
        ///////////////////////////////////////////
        function themify_facebook_url($data=array()){
                $data = get_data();
                if($data['setting-facebook_disable']){
                        $checked = "checked";
                }
                return '<p><span class="label">' . __('Custom Facebook URL', 'themify') . '</span> <input type="text" class="width10" name="setting-facebook_url" value="'.$data['setting-facebook_url'].'" /> <br />
                                        <span class="pushlabel"><small>Default: http://www.facebook.com/universityofri</small></span><br />
                                        <span class="pushlabel"><input type="checkbox" name="setting-facebook_disable" '.$checked.'/> Disable Facebook Icon</span>
                                </p>';
        }

        ///////////////////////////////////////////
        // Custom Facebook URL Module - Action
        ///////////////////////////////////////////
        function themify_facebook_url_action($data=array()){
                $data = get_data();
                if($data['setting-facebook_url'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-facebook_url'].'" /> ';
                }
                if($data['setting-facebook_disable'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-facebook_disable'].'" /> ';
                }
        }
        add_action('wp-admin','themify_facebook_url_action');

        ///////////////////////////////////////////
        // Custom Twitter URL Module
        ///////////////////////////////////////////
        function themify_twitter_url($data=array()){
                $data = get_data();
                if($data['setting-twitter_disable']){
                        $checked = "checked='checked'";
                }
                return '<p><span class="label">Custom Twitter URL</span>
                                        <input type="text" class="width10" name="setting-twitter_url" value="'.$data['setting-twitter_url'].'" /> <br />
                                        <span class="pushlabel"><small>Default: http://twitter.com/#!/urinews</small></span><br />
                                        <span class="pushlabel"><input type="checkbox" name="setting-twitter_disable" '.$checked.'/> Disable Twitter Icon</span>
                                </p>';
        }

        ///////////////////////////////////////////
        // Custom Twitter URL Module - Action
        ///////////////////////////////////////////
        function themify_twitter_url_action($data=array()){
                $data = get_data();
                if($data['setting-twitter_url'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-twitter_url'].'" /> ';
                }
                if($data['setting-twitter_disable'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-twitter_disable'].'" /> ';
                }
        }
        add_action('wp-admin','themify_twitter_url_action');

        ///////////////////////////////////////////
        // Custom Google+ URL Module
        ///////////////////////////////////////////
        function themify_google_plus_url($data=array()){
                $data = get_data();
                if($data['setting-google_plus_disable']){
                        $checked = "checked='checked'";
                }
                return '<p><span class="label">Custom Google+ URL</span>
                                        <input type="text" class="width10" name="setting-google_plus_url" value="'.$data['setting-google_plus_url'].'" /> <br />
                                        <span class="pushlabel"><small>Default: https://plus.google.com/117011233656720960212</small></span><br />
                                        <span class="pushlabel"><input type="checkbox" name="setting-google_plus_disable" '.$checked.'/> Disable Google+ Icon</span>
                                </p>';
        }

        ///////////////////////////////////////////
        // Custom Google+ URL Module - Action
        ///////////////////////////////////////////
        function themify_google_plus_url_action($data=array()){
                $data = get_data();
                if($data['setting-google_plus_url'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-google_plus_url'].'" /> ';
                }
                if($data['setting-google_plus_disable'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-google_plus_disable'].'" /> ';
                }
        }
        add_action('wp-admin','themify_google_plus_url_action');

        ///////////////////////////////////////////
        // Custom YouTube URL Module
        ///////////////////////////////////////////
        function themify_youtube_url($data=array()){
                $data = get_data();
                if($data['setting-youtube_disable']){
                        $checked = "checked='checked'";
                }
                return '<p><span class="label">Custom YouTube URL</span>
                                        <input type="text" class="width10" name="setting-youtube_url" value="'.$data['setting-youtube_url'].'" /> <br />
                                        <span class="pushlabel"><small>Default: http://www.youtube.com/user/UniversityOfRI</small></span><br />
                                        <span class="pushlabel"><input type="checkbox" name="setting-youtube_disable" '.$checked.'/> Disable YouTube Icon</span>
                                </p>';
        }

        ///////////////////////////////////////////
        // Custom YouTube URL Module - Action
        ///////////////////////////////////////////
        function themify_youtube_url_action($data=array()){
                $data = get_data();
                if($data['setting-youtube_url'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-youtube_url'].'" /> ';
                }
                if($data['setting-youtube_disable'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-youtube_disable'].'" /> ';
                }
        }
        add_action('wp-admin','themify_youtube_url_action');
	...
	function themify_custom_feed_url($data=array()){
		$data = get_data();
                if($data['setting-custom_feed_disable']){
                        $checked = "checked='checked'";
                }
		return '<p><span class="label">' . __('Custom Feed URL', 'themify') . '</span> <input type="text" class="width10" name="setting-custom_feed_url" value="'.$data['setting-custom_feed_url'].'" /> <br />
					<span class="pushlabel"><small>Default: rss2_url</small></span><br />
                                        <span class="pushlabel"><input type="checkbox" name="setting-custom_feed_disable" '.$checked.'/> Disable RSS Icon</span>
                                </p>';
	}
	...
	function themify_custom_feed_url_action($data=array()){
		...
		if($data['setting-custom_feed_url'] != ""){
			echo "\n\n".'<meta name="description" content="'.$data['setting-custom_feed_url'].'" /> ';
                ...
                if($data['setting-custom_feed_disable'] != ""){
                        echo "\n\n".'<meta name="description" content="'.$data['setting-custom_feed_disable'].'" /> ';
                }
	}
